...
// Stub component - vaul not available
const Drawer = ({ children, ...props }: React.ComponentProps<"div">) => (
...
const DrawerTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
...
const DrawerDescription = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
